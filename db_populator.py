...
class DBPopulator:
   ...
   def __init__(self, local_db_api, imdb):
...
#            break
      ...
      logging.debug("Total: " + str(self.num_films_processed) + " IMDB Lookups:" + str(self.imdb.api_calls) + " Format Errors:" + str(len(pattern_mismatches)))
